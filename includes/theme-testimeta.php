...
$meta_box_testi = array(
	...
	'title' =>  __('Testimonial Options', 'theme1843'),
	'page' => 'testi',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Name', 'theme1843'),
    	   'desc' => __('Input author\'s name. ', 'theme1843'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input author\'s URL.', 'theme1843'),
    	   'id' => $prefix . 'testi_url',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	   ...
    	   'desc' => __('Input author\'s additional info.', 'theme1843'),
...
function my_show_box_testi() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for testimonial. ', 'theme1843').'</p>';
