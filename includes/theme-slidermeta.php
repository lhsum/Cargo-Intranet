...
$meta_box_slider = array(
	...
	'title' =>  __('Slider Options', 'theme1843'),
	'page' => 'slider',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Caption', 'theme1843'),
    	   'desc' => __('Input your caption for slide (HTML tags are allowed). ', 'theme1843'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input the slide URL (can be external link)', 'theme1843'),
...
function my_show_box_slider() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for slide. ', 'theme1843').'</p>';
