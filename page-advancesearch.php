...
<tr><td>Name : </td><td><input type="text" name="search_name" placeholder=" -- Name -- " style="width:200px" class="searchTrigger"/></td></tr>
<tr><td>Position : </td><td><input type="text" name="position" placeholder=" -- Position -- " style="width:200px" value="" class="searchTrigger"/></td></tr>
<tr><td>Email :</td><td> <input type="text" name="email" placeholder=" -- Email -- " style="width:200px" value="" class="searchTrigger"/></td></tr>
<tr><td>Phone : </td><td><input type="text" name="phone" placeholder=" -- Phone -- " style="width:200px" value="" class="searchTrigger"/></td></tr>
<!--<tr><td>Address :</td><td> <input type="text" name="address" placeholder=" -- Address -- " style="width:200px" value="" class="searchTrigger"/></td></tr>-->
	...
	<br/>
	No record found. Please search again.
	</div>
