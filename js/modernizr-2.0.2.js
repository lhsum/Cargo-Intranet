/* Modernizr 2.0.2 (Custom Build) | MIT & BSD
 * Contains: fontface | opacity | rgba | input | inputtypes | iepp | mq | cssclasses | teststyles | prefixes | load
 */
;
window.Modernizr = function (a, b, c) {
    ...
    var C = function (a, c) {
        ...
        }(['@font-face {font-family:"font";src:url("//:")}'], ["fontface"]);
    p.rgba = function () {
    ...
    e.input || D(), y(""), j = l = null, a.attachEvent &&
    function () {
    ...
    }(a, b), e._version = d, e._prefixes = o, e.mq = u, e.testStyles = t, g.className = g.className.replace(/\bno-js\b/, "") + (f ? " js " + s.join(" ") : "");
    return e
    ...
    function h(a) {
        var c = b.createElement("link"),
            d;
        c.href = a.s, c.rel = "stylesheet", c.type = "text/css", !a.e && (w || r) ?
        function a(b) {
            m(function () {
                if (!d) try {
