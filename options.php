...
*/
add_action( 'customize_register', 'theme1843_register' );

if(!function_exists('theme1843_register')) {

	function theme1843_register($wp_customize) {
		/**
		...
		/*	General
		/*-----------------------------------------------------------------------------------*/
		$wp_customize->add_section( 'theme1843_header', array(
			'title' => __( 'General', 'theme1843' ),
			'priority' => 200
		));
		
		/* Background Image*/
		$wp_customize->add_setting( 'theme1843[body_background][image]', array(
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'body_background_image', array(
			...
			'section' => 'theme1843_header',
			'settings'   => 'theme1843[body_background][image]'
		) ) );
		
		
		/* Background Color*/
		$wp_customize->add_setting( 'theme1843[body_background][color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'body_background', array(
			...
			'section' => 'theme1843_header',
			'settings'   => 'theme1843[body_background][color]'
		) ) );
		
		/* Header Color */
		$wp_customize->add_setting( 'theme1843[header_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_color', array(
			...
			'section' => 'theme1843_header',
			'settings'   => 'theme1843[header_color]'
		) ) );
		
		
		/* Body Font Face */
		$wp_customize->add_setting( 'theme1843[google_mixed_3][face]', array(
			'default' => $options['google_mixed_3']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1843_google_mixed_3', array(
				'label' => $options['google_mixed_3']['name'],
				'section' => 'theme1843_header',
				'settings' => 'theme1843[google_mixed_3][face]',
				'type' => 'select',
		...
		$wp_customize->add_setting( 'theme1843[links_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'links_color', array(
			...
			'section' => 'theme1843_header',
			'settings'   => 'theme1843[links_color]'
		) ) );
		
		/* H1 Heading font face */
		$wp_customize->add_setting( 'theme1843[h1_heading][face]', array(
			'default' => $options['h1_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1843_h1_heading', array(
				'label' => $options['h1_heading']['name'],
				'section' => 'theme1843_header',
				'settings' => 'theme1843[h1_heading][face]',
				'type' => 'select',
				'choices' => $options['h1_heading']['options']['faces']
		) );
		
		/* H2 Heading font face */
		$wp_customize->add_setting( 'theme1843[h2_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1843_h2_heading', array(
				'label' => $options['h2_heading']['name'],
				'section' => 'theme1843_header',
				'settings' => 'theme1843[h2_heading][face]',
				'type' => 'select',
				'choices' => $options['h2_heading']['options']['faces']
		) );
		
		/* H6 Heading font face */
		$wp_customize->add_setting( 'theme1843[h6_heading][face]', array(
			'default' => $options['h6_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1843_h6_heading', array(
				'label' => $options['h6_heading']['name'],
				'section' => 'theme1843_header',
				'settings' => 'theme1843[h6_heading][face]',
				'type' => 'select',
				'choices' => $options['h6_heading']['options']['faces']
		) );
		
		/* H5 Heading font face */
		$wp_customize->add_setting( 'theme1843[h5_heading][face]', array(
			'default' => $options['h5_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1843_h5_heading', array(
				'label' => $options['h5_heading']['name'],
				'section' => 'theme1843_header',
				'settings' => 'theme1843[h5_heading][face]',
				'type' => 'select',
				'choices' => $options['h5_heading']['options']['faces']
		) );
		
		/* H4 Heading font face */
		$wp_customize->add_setting( 'theme1843[h4_heading][face]', array(
			'default' => $options['h4_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1843_h4_heading', array(
				'label' => $options['h4_heading']['name'],
				'section' => 'theme1843_header',
				'settings' => 'theme1843[h4_heading][face]',
				'type' => 'select',
				'choices' => $options['h4_heading']['options']['faces']
		) );
		
		/* H3 Heading font face */
		$wp_customize->add_setting( 'theme1843[h3_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme1843_h3_heading', array(
				'label' => $options['h3_heading']['name'],
				'section' => 'theme1843_header',
				'settings' => 'theme1843[h3_heading][face]',
				'type' => 'select',
		...
		/* Search Box */
		$wp_customize->add_setting( 'theme1843[g_search_box_id]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_g_search_box_id', array(
				'label' => $options['g_search_box_id']['name'],
				'section' => 'theme1843_header',
				'settings' => 'theme1843[g_search_box_id]',
		...
		$wp_customize->add_section( 'theme1843_logo', array(
			'title' => __( 'Logo', 'theme1843' ),
			'priority' => 201
		) );
		
		/* Logo Type */
		$wp_customize->add_setting( 'theme1843[logo_type]', array(
				'default' => $options['logo_type']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_logo_type', array(
				'label' => $options['logo_type']['name'],
				'section' => 'theme1843_logo',
				'settings' => 'theme1843[logo_type]',
				'type' => $options['logo_type']['type'],
				'choices' => $options['logo_type']['options']
		) );
		
		/* Logo Path */
		$wp_customize->add_setting( 'theme1843[logo_url]', array(
			'type' => 'option'
		) );
		...
		$wp_customize->add_section( 'theme1843_slider', array(
			'title' => __( 'Slider', 'theme1843' ),
			'priority' => 202
		) );
		
		/* Slider Effect */
		$wp_customize->add_setting( 'theme1843[sl_effect]', array(
				'default' => $options['sl_effect']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_effect', array(
				'label' => $options['sl_effect']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_effect]',
				'type' => $options['sl_effect']['type'],
				'choices' => $options['sl_effect']['options']
		) );
		
		/* Slices */
		$wp_customize->add_setting( 'theme1843[sl_slices]', array(
				'default' => $options['sl_slices']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_slices', array(
				'label' => $options['sl_slices']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_slices]',
				'type' => $options['sl_slices']['type'],
				'choices' => $options['sl_slices']['options']
		) );
		
		/* Box columns */
		$wp_customize->add_setting( 'theme1843[sl_box_columns]', array(
				'default' => $options['sl_box_columns']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_box_columns', array(
				'label' => $options['sl_box_columns']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_box_columns]',
				'type' => $options['sl_box_columns']['type'],
				'choices' => $options['sl_box_columns']['options']
		) );
		
		/* Box rows */
		$wp_customize->add_setting( 'theme1843[sl_box_rows]', array(
				'default' => $options['sl_box_rows']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_box_rows', array(
				'label' => $options['sl_box_rows']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_box_rows]',
		...
		/* Animation speed */
		$wp_customize->add_setting( 'theme1843[sl_animation_speed]', array(
				'default' => $options['sl_animation_speed']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_animation_speed', array(
				'label' => $options['sl_animation_speed']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_animation_speed]',
				'type' => $options['sl_animation_speed']['type']
		) );
		
		/* Pause time */
		$wp_customize->add_setting( 'theme1843[sl_pausetime]', array(
				'default' => $options['sl_pausetime']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_pausetime', array(
				'label' => $options['sl_pausetime']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_pausetime]',
				'type' => $options['sl_pausetime']['type']
		) );
		
		
		/* Display next & prev navigation? */
		$wp_customize->add_setting( 'theme1843[sl_dir_nav]', array(
				'default' => $options['sl_dir_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_dir_nav', array(
				'label' => $options['sl_dir_nav']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_dir_nav]',
		...
		$wp_customize->add_setting( 'theme1843[sl_dir_nav_hide]', array(
				'default' => $options['sl_dir_nav_hide']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_dir_nav_hide', array(
				'label' => $options['sl_dir_nav_hide']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_dir_nav_hide]',
		...
		/* Show pagination? */
		$wp_customize->add_setting( 'theme1843[sl_control_nav]', array(
				'default' => $options['sl_control_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_sl_control_nav', array(
				'label' => $options['sl_control_nav']['name'],
				'section' => 'theme1843_slider',
				'settings' => 'theme1843[sl_control_nav]',
		...
		$wp_customize->add_section( 'theme1843_blog', array(
				'title' => __( 'Blog', 'theme1843' ),
				'priority' => 203
		) );
		
		/* Blog image size */
		$wp_customize->add_setting( 'theme1843[post_image_size]', array(
				'default' => $options['post_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_post_image_size', array(
				'label' => $options['post_image_size']['name'],
				'section' => 'theme1843_blog',
				'settings' => 'theme1843[post_image_size]',
				'type' => $options['post_image_size']['type'],
				'choices' => $options['post_image_size']['options']
		) );
		
		/* Single post image size */
		$wp_customize->add_setting( 'theme1843[single_image_size]', array(
				'default' => $options['single_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_single_image_size', array(
				'label' => $options['single_image_size']['name'],
				'section' => 'theme1843_blog',
				'settings' => 'theme1843[single_image_size]',
				'type' => $options['single_image_size']['type'],
				'choices' => $options['single_image_size']['options']
		) );
		
		/* Post Meta */
		$wp_customize->add_setting( 'theme1843[post_meta]', array(
				'default' => $options['post_meta']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_post_meta', array(
				'label' => $options['post_meta']['name'],
				'section' => 'theme1843_blog',
				'settings' => 'theme1843[post_meta]',
				'type' => $options['post_meta']['type'],
				'choices' => $options['post_meta']['options']
		) );
		
		/* Post Excerpt */
		$wp_customize->add_setting( 'theme1843[post_excerpt]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_post_excerpt', array(
				'label' => $options['post_excerpt']['name'],
				'section' => 'theme1843_blog',
				'settings' => 'theme1843[post_excerpt]',
		...
		$wp_customize->add_section( 'theme1843_footer', array(
			'title' => __( 'Footer', 'theme1843' ),
			'priority' => 204
		) );
			
		/* Footer Copyright Text */
		$wp_customize->add_setting( 'theme1843[footer_text]', array(
				'default' => $options['footer_text']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_footer_text', array(
				'label' => $options['footer_text']['name'],
				'section' => 'theme1843_footer',
				'settings' => 'theme1843[footer_text]',
				'type' => 'text'
		) );
		
		
		/* Display Footer Menu */
		$wp_customize->add_setting( 'theme1843[footer_menu]', array(
				'default' => $options['footer_menu']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme1843_footer_menu', array(
				'label' => $options['footer_menu']['name'],
				'section' => 'theme1843_footer',
				'settings' => 'theme1843[footer_menu]',
