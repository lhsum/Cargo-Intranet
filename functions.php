<?php
	...
	// Add the postmeta to Manufacturers posts
	include_once(PARENT_DIR . '/includes/theme-manufacturersmeta.php');
	
	
	//Loading theme textdomain
	load_theme_textdomain( 'theme1843', PARENT_DIR . '/languages' );
